...
console.log("Afficher *un par un* tous les éléments du tableau tab1.")
...
console.log("Ajouter *un par un* tous les éléments du tableau tab2 à la fin du tableau tab1.")
...
console.log("Afficher la taille du tableau tab1.")
...
console.log("Diviser par 2 toutes les variables contenues dans le tableau tab1.")
for(let i =0; i< tab1.length; i++){
    tab1[i] = tab1[i]/2;
}
