...
insert into message (contenu_message, date_message, statut_message)
values("passe-moi le sel stp!", "2023-07-13", 1), ("il est au milieu", "2023-07-13", 1);

insert into echanger (id_emetteur, id_destinataire, id_message)
values(2, 3, 1), (3, 2, 2);

select *
from message, echanger
where message.id_message = echanger.id_message;

*/

insert into utilisateur (nom_utilisateur, prenom_utilisateur, mail_utilisateur, password_utilisateur, statut_utilisateur)
values ("Serda", "Kevin", "kevin.serda@gmail.com", "kekeleboss", 1);

insert into utilisateur (nom_utilisateur, prenom_utilisateur, mail_utilisateur, password_utilisateur, statut_utilisateur)
values ("Jemaoui", "Leyla", "leyla.jemaoui@gmail.com", "moutardelover", 1);

insert into utilisateur (nom_utilisateur, prenom_utilisateur, mail_utilisateur, password_utilisateur, statut_utilisateur)
values ("Kenobi", "Obi-Wan", "obi_wan.kenobi@gmail.com", "forcebewithyou", 2);

insert into utilisateur (nom_utilisateur, prenom_utilisateur, mail_utilisateur, password_utilisateur, statut_utilisateur)
values ("Luke", "Lucky", "lucky.luke@gmail.com", "sacré_Rantanplan!", 3);

insert into role (nom_role)
values ("utilisateur"),("artiste"),("admin");

insert into groupe (nom_groupe)
values ("peinture"),("vidéo"),("dessin");

insert into article (nom_article, contenu_article, date_article, statut_article, id_utilisateur)
values ("Chien chaud", "peinture à l'huile", "1865-08-15", 1, 5), ("Petit manifeste sur le double saut", "manuel didactique", "3824-10-10", 1, 4), ("Pompes yeah !", "chanson urbaine", "2021-12-05", 1, 2), ("La Blague du thé...", "plaisanterie sans chute", "2023-06-29", 0, 3);

insert into categorie (nom_categorie)
values ("new"),("actualité"),("oeuvre");

insert into media (url_media, nom_media)
values("www.chien-chaud.com", "site vitrine"),("www.obi_wan_kenobi.jedi", "site e-commerce"),("www.spotify.com/kevin_serda/pompes_yeah/", "streaming musical");
